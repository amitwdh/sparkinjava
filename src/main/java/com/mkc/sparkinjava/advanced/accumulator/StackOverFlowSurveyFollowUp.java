package com.mkc.sparkinjava.advanced.accumulator;
...
public class StackOverFlowSurveyFollowUp {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaRDD<String> responseRDD = javaSparkContext.textFile("src/in/2016-stack-overflow-survey-responses.csv");
		...
		JavaRDD<String> responseFromCanada = responseRDD.filter(response -> {
			...
			// increase the missingSalaryMidPoint accumulator by 1 if the salary middle
			// point is not present in the reponse
