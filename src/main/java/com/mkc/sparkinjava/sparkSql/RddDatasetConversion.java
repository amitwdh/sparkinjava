...
public class RddDatasetConversion {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaRDD<String> lines = sc.textFile("src/in/2016-stack-overflow-survey-responses.csv");

		JavaRDD<Response> responseRDD = lines
				.filter(line -> !line.split(Utils.COMMA_DELIMITER, -1)[2].equals("country")).map(line -> {
