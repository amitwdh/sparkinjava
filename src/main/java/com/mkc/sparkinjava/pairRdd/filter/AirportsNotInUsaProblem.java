package com.mkc.sparkinjava.pairRdd.filter;
...
public class AirportsNotInUsaProblem {
	...
	public static void main(String[] args) {
		 ...
		 * the value. Then remove all the airports which are located in United States
		 * and output the pair RDD to out/airports_not_in_usa_pair_rdd.text
		 * 
		 * 
