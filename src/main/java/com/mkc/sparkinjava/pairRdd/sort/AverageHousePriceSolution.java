package com.mkc.sparkinjava.pairRdd.sort;
...
import com.mkc.sparkinjava.pairRdd.aggregation.reducebykey.housePrice.AvgCount;
...
public class AverageHousePriceSolution {
	...
	public static void main(String[] args) {
		...
		JavaRDD<String> lines = sc.textFile("src/in/RealEstate.csv");
