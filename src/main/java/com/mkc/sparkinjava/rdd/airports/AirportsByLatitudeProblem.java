...
public class AirportsByLatitudeProblem {
	...
	public static void main(String[] args) {
		...
		/*
		 * Create a Spark program to read the airport data from in/airports.text, find
		 * all the airports whose latitude are bigger than 40. Then output the airport's
		 * name and the airport's latitude to out/airports_by_latitude.text.
		 * 
